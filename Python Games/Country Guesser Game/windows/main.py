...
class StartPage(tk.Frame):
    def __init__(self, master):
        ...
        ImagePath = "C:/Users/samue/OneDrive/Documents/Python Games/Country Guesser Game/windows/halloween.png"
...
class CategoryPage(tk.Frame):
    def __init__(self, master):
        ...
        prevBtn = tk.Button(self, text="previous page", foreground="yellow",
                            width=15, height=1,
                            background="black", font=btnFont, relief="ridge",
                            borderwidth=5, highlightbackground="yellow",
                            activebackground="yellow", activeforeground="black",
...
class CountryPage(tk.Frame):
    def __init__(self, master):
        ...
        filename = random.choice(os.listdir("C:/Users/samue/OneDrive/Documents/Python Games/Country Guesser Game/windows/images"))
        code = filename.split(".")[0]

        # Check if the code exists in the dataframe
        while code.upper() not in df.index:
            filename = random.choice(os.listdir("C:/Users/samue/OneDrive/Documents/Python Games/Country Guesser Game/windows/images"))
            code = filename.split(".")[0]

        countryPath = os.path.join("C:/Users/samue/OneDrive/Documents/Python Games/Country Guesser Game/windows/images", filename)

        print(countryPath)
        print(df["country"][code.upper()])
        answer = df["country"][code.upper()]

        backgroundPath = "C:/Users/samue/OneDrive/Documents/Python Games/Country Guesser Game/windows/halloween.png"
        canv = tk.Canvas(self, width=600, height=500, bg='white')
        canv.pack()
    ...
    def checkBtn_click(self, master, user_text, check_answer, canv, check_img):
        ...
        if (user_text == check_answer):
            # correct
            print('맞았습돠')
            ImagePath = "C:/Users/samue/OneDrive/Documents/Python Games/Country Guesser Game/windows/correct.png"
            ...
            # wrong
            print('틀렸슴돠')
            ImagePath = "C:/Users/samue/OneDrive/Documents/Python Games/Country Guesser Game/windows/wrong.png"
...
class FinishPage(tk.Frame):
    def __init__(self, master):
        ...
        canv.create_text((600 // 2), (500 // 2), fill="white", text="Pass count : " + str(pass_count)+ "/3", font=labelFont)

        startBtnFont = tkFont.Font(family="Consolas", size=20)
        startBtn = tk.Button(canv, text="Restart", font=startBtnFont, foreground="yellow", background="black",
                             relief="ridge", borderwidth=5, highlightbackground="yellow",
                             activebackground="yellow", activeforeground="black",
                             command=lambda: master.switch_frame(StartPage))
        canv.create_window((600 // 2), (500 // 2) + 100, window=startBtn)
...
if __name__ == "__main__":
    ...
    correct_count = 0
    problem_count = 15
    df = pd.read_excel("C:/Users/samue/OneDrive/Documents/Python Games/Country Guesser Game/windows/CountryCodeData.xlsx", index_col=0)
    app = SampleApp()
    app.mainloop()
